...
st.markdown(
    ...
    .stNumberInput label, .stNumberInput span {
        color: #fff !important;
        font-family: 'Times New Roman', Times, serif !important;s
    }
    ...
    .custom-title {
        ...
        color: #fff;
        font-weight: 300;
        text-shadow: 3px 3px 12px #888888, 0 0 10px #000; /* gray shadow */
        margin-bottom: 0.5em;
        margin-top: 0.5em;
        text-align: center;
        letter-spacing: 2px;
...
st.markdown(
    """
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Times+New+Roman:wght@300&display=swap');
    .custom-title {
        font-family: 'Times New Roman', Times, serif !important;
        font-size: 4rem;
        color: #fff;
...
# Title of the app with white shadow
st.markdown(
    "<h1 class='custom-title'>PREDICT HOUSE PRICE OF INDIA</h1>",
    unsafe_allow_html=True
)

st.divider()

# Description of the app in Times New Roman
st.markdown(
